...
Revision ID: 08f6661e05db
Revises: 4622724d4731
Create Date: 2026-01-05 05:50:15.050792
...
revision: str = '08f6661e05db'
down_revision: Union[str, None] = '4622724d4731'
...
def upgrade() -> None:
    ...
    sa.Column('name', sa.Enum('USDC', 'USDT', 'cNGN', name='assettype'), nullable=False),

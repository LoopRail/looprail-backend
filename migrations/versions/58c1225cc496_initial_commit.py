...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "ledger_identiy_id", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "replaced_by_hash", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("revoked_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "chain",
            sa.Enum("POLYGON", "BASE", "ETHEREUM", "BITCOIN", name="chain"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "ledger_balance_id", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column("blockrader_asset_id", sa.Uuid(), nullable=False),
        sa.Column(
            "asset_type",
            sa.Enum("USDC", "USDT", "cNGN", name="assettype"),
            nullable=False,
        ),
        sa.Column("address", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        ...
        sa.Column(
            "standard",
            sa.Enum("ERC20", "BEP20", "TRC20", name="tokenstandard"),
            nullable=True,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.ForeignKeyConstraint(
